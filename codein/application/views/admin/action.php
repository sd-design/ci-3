...
<body id="dashboard">
  <div class="container">
    <div class="mt-3 mb-3">
      ...
      <div class="text-right"><a href="<?php echo base_url();?>admin/dashboard" class="btn btn-success">Dashboard</a>&nbsp;<a href="<?php echo base_url();?>admin/login/out" class="btn btn-danger"><?=lang('btn_logout');?></a></div>
    </div>
<hr>
      <div class="row">
          <div class="col-sm-6">
