...
<body id="dashboard">
  <div class="container">
    <div class="mt-3 mb-3">
      <h1 class="display-4">New slide for slider</h1>
...
<hr>
      <div class="row">
          <div class="col-sm-6">
              <?php echo form_open('/admin/slider/save', 'id="category-form"');?>
              <input type="hidden" name="new_image" value="" id="slide_image">
              <div class="form-group">
                  <label for="exampleInputEmail1">Title of slide</label>
                  <input type="text" class="form-control" name="title" id="slider_title" required>

              </div>
              <div class="form-group">
                  <label for="exampleInputEmail1">Link for slide</label>
                  <input type="text" class="form-control" name="link" id="slider_link">

              </div>
              <div class="form-group">
                  <label for="exampleInputEmail1">Sort</label>
                  <input type="text" class="form-control" name="sort" id="category_slug">
                  <small id="emailHelp" class="form-text text-muted">Default value 100.</small>
              </div>

              <div class="form-group text-left">
                  <button type="submit" class="btn btn-primary">Save new slide</button>
              </div>
              </form>
          </div>
          <div class="col-sm-6 border pt-3">
<button type="button" class="btn btn-lg btn-info" data-toggle="modal" data-target="#uploadModal">Upload image</button>
              <div class="new_image pt-4">
                  <img src="" id="currentImage" alt="" width="100%">
              </div>
          </div>
